...
void loop() {
  ...
  char buffer[64];
  sprintf(buffer, "%0.2f,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f", time, temperature, pressure, humidity, altitude, lux, voc_index, co2, uvb_index);
  ...
  sprintf(buffer, "%0.2fC\t%0.2fhPa\t%0.2f\t%0.2fm\t%0.2flux\t%0.0f\t%0.0fppm\t%0.2f", temperature, pressure, humidity, altitude, lux, voc_index, co2, uvb_index);
